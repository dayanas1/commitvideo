            ...
            <View>
                <ScrollView>
                    ...
                    <SongButton
                        ...
                        onPress={() => playAudio(require('./assets/AudiosRock/a-ha-Take On Me.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                    <SongButton
                        title="The Outfield - Your Love"
                        onPress={() => playAudio(require('./assets/AudiosRock/The Outfield - Your Love.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                    <SongButton
                        title="Toto -Africa"
                        onPress={() => playAudio(require('./assets/AudiosRock/Toto - Africa.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                    <SongButton
                        title="Michael Jackson - Billie Jean"
                        onPress={() => playAudio(require('./assets/AudiosRock/Michael Jackson - Billie Jean.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                    <SongButton
                        title="Boney M - Rasputin"
                        onPress={() => playAudio(require('./assets/AudiosRock/Boney M. - Rasputin.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                    <SongButton
                        title="Green Day - The Grouch"
                        onPress={() => playAudio(require('./assets/AudiosRock/Green Day - The Grouch.mp3'))}
                        icon={require('../image/calibrador.png')}
                    />
                </ScrollView>
            </View>
